    ...
    if request.method == 'POST':
        ...
        try:
            ...
            error = {
                "result": "Error",
                "steps": [
                    f"<span class='text-red-500'>Error: {str(e)}</span>"
                ]
            }
    ...
    if request.method == 'POST':
        ...
        try:
            ...
            error = {
                "result": "Error",
                "steps": [
                    "<span class='text-red-500'>Error: Invalid input for a or b.</span>"
                ]
            }
    ...
    if request.method == 'POST':
        ...
        try:
            ...
            error = {
                "result": "Error",
                "steps": [
                    "<span class='text-red-500'>Error: Invalid matrix input.</span>"
                ]
            }
